...
@section('content')
    @include('admin.users.partials.header', [
        'title' => __('EDIT Course') . ' '. auth()->user()->name,
    ])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                    <form action="{{route('courses.update', $course)}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                    ...
                    <div class="pl-lg-4">
                        ...
                        <input type="text" name="title" value="{{$course->title}}" id="input-title" class="form-control
                        ...
                        <div class="form-group{{ $errors->has('track_id') ? 'has-danger' : ' '}}">
                            ...
                            <select name="track_id" id="input-track_id" required class="form-control">
                                ...
                                <option value="{{$track->id}}" {{ ( $track->name == $course->track->name) ? 'selected' : '' }}>{{$track->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group{{ $errors->has('link') ? 'has-danger' : ' '}}">
                            ...
                            <input type="text" name="link" value="{{$course->link}}" id="input-link" class="form-control
                        ...
                        form-control-alternative{{ $errors->has('img') ? 'is-invaild' : ' '}}" >
