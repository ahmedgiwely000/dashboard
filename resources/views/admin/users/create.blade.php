...
@section('content')
    @include('admin.users.partials.header', [
        'title' => __('Add Users') . ' '. auth()->user()->name,
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                            <h3 class="mb-0">{{ __('UserManagement') }}</h3>
                            </div>
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password-confirmation" id="input-password-confirmation" class="form-control
