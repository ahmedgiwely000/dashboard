            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    ...
                    <div class="media-body ml-2 d-none d-lg-block">
                        <span class="mb-0 text-sm  font-weight-bold">Ahmed</span>
                    </div>
                </div>
            </a>
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
...
<div class="container-fluid mt--7">
    <div class="row">
        <div class="col">
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <h3 class="mb-0 text-center">Tracks</h3>
                        </div>
                    </div>
                </div>
                <div class="col-12">
            ...
            <form action="{{route('tracks.update' , $tracks)}}" method="POST" autocomplete="off">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-sm-9 ml-2">
                    <input type="text" name="name" value="{{$tracks->name}}" class="form-control form-control-lg mb-4" placeholder="name tracks">
                    </div>
                    <div class="col-sm-2">
                        <input type="submit" name="addtrack" value="Ubdate Tracks" class=" btn btn-primary p-3">
                    </div>
                </div>
            </form>
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                          <tr>
                            <td>{{$tracks->name}}</td>
                            <td>{{$tracks->created_at->format('d/m/y H:i')}}</td>
                            <td class="text-right">
                                    <div class="dropdown">
                                    ...
                                    <form action="{{route('tracks.destroy', $tracks)}}" method="POST">
                                        @csrf
                                        @method('delete')
                                    <a class="dropdown-item" href="{{route('tracks.edit' ,$tracks)}}">{{__("Edit")}}</a>
