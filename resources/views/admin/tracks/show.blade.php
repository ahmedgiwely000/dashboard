    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                <div class="card-header border-0 bg-dark mb-3">
                    <div class="row align-items-center">
                        <div class="col-8">
                        <h3 class="mb-0 text-success">Courses for :: {{$track->name}}</h3>
                        </div>
                        <div class="col-4 text-right">
                        <a href="{{route('tracks.courses.create',$track)}}" class="btn btn-sm btn-primary">New Course</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="row mx-auto">
                      ...
                      <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <h4 class="card-title">track for : <span class="font-italic text-success">{{$course->track->name}}</span></h4>
                        </div>
                          <div class="card-footer ">
                          <form action="{{route('courses.destroy',$course)}}" method="POST" class="d-flex">
                            @csrf
                            @method('delete')
                ...
                @else
                <div class="text-uppercase text-danger font-weight-bold text-center">no Courese found</div>
                @endif
