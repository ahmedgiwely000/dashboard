            ...
            <form action="{{route('tracks.store')}}" method="POST" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-sm-9 ml-2">
                        <input type="text" name="name" class="form-control form-control-lg mb-4" placeholder="name tracks">
                    </div>
                    <div class="col-sm-2">
                        <input type="submit" name="addtrack" value="Add Tracks" class=" btn btn-primary p-3">
                    </div>
                </div>
            </form>
                @if (count($tracks))
