...
@section('content')
    @include('admin.users.partials.header', [
        'title' => __('Edit video') . ' '. auth()->user()->name,
    ])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <form action="{{route('videos.update',$video)}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method("patch")
                    ...
                    <div class="pl-lg-4">
                        ...
                        <input type="text" name="title" value="{{$video->title}}" id="input-title" class="form-control
                        ...
                        <div class="form-group{{ $errors->has('course_id') ? 'has-danger' : ' '}}">
                            ...
                            <select name="course_id" id="input-course_id" required class="form-control">
                                ...
                                <option value="{{$course->id}}" {{ $course->title == $video->course->title ? 'selected' : ''}}>{{$course->title}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group{{ $errors->has('link') ? 'has-danger' : ' '}}">
                            ...
                            <input type="text" name="link" value="{{$video->link}}" id="input-link" class="form-control
